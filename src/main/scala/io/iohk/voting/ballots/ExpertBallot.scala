package io.iohk.voting.ballots
...
import io.iohk.core.{Ciphertext, Cryptosystem}
import io.iohk.core.serialization.Serializer
import io.iohk.nizk.shvzk.{SHVZKProof, SHVZKProofSerializer}
import io.iohk.voting.Voter
