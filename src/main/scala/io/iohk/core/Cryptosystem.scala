...
import io.iohk.core
import io.iohk.core.encryption.elgamal.{ElGamalEnc, LiftedElGamalEnc}
import io.iohk.core.encryption.hybrid.{HybridCiphertext, HybridEncryption}
import io.iohk.core.primitives.blockcipher.BlockCipherFactory
import io.iohk.core.primitives.blockcipher.BlockCipherFactory.AvailableBlockCiphers
import io.iohk.core.primitives.dlog.{DiscreteLogGroupFactory, GroupElement}
...
//  }
  ...
  def createKeyPair: (PrivKey, PubKey) = core.encryption.createKeyPair.get
