...
import treasury.crypto.nizk.shvzk_new.{SHVZKCommon, SHVZKGen, SHVZKProofSerializer, SHVZKVerifier}

class SHVZKTestNew extends FunSuite with TableDrivenPropertyChecks {
